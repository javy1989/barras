...
public class RestFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        //og.debug("Method Name : {} ", resourceInfo.getResourceMethod().getName());
...
//        long executionTime = System.currentTimeMillis() - startTime;
        ...
        responseContext.getHeaders().add("Access-Control-Allow-Headers", "Authorization, X-Requested-With, Content-Type, Accept");
